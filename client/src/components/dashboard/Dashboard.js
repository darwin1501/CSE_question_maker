...
export default function Dashboard (props) {
  return (
    ...
    >
      <div
        className={DashboardStyle.total_question_card}
      ...
      >
        ...
        <div className={DashboardStyle.flex}>
          <p>Numerical:</p>{' '}
          <p className={DashboardStyle.bold}>{props.numerical}</p>
        </div>
        <div className={DashboardStyle.flex}>
          <p>Analytical:</p>{' '}
        ...
        <div className={DashboardStyle.flex}>
          <p>Philippine Constitution:</p>{' '}
          <p className={DashboardStyle.bold}>{props.philCon}</p>
        </div>
        <div className={DashboardStyle.flex}>
