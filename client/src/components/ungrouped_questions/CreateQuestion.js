...
export default function CreateQuestion(props) {
    ...
    async function addQuestion(event) {
        ...
        // When a post request is sent to the create url, we'll add a new record to the database.
          ...
          const isQuestionExist = await Checker.hasQuestionDuplicate(newQuestion.question);
          ...
          if(isQuestionExist === true){
            ...
            //TODO:  create props for updating UI updateUI();
            props.updateUI()
        ...
        <div>
            <div className="modal-container">
                ...
                <form onSubmit={addQuestion}>
                    ...
                    <label>
                        Question
                        <textarea value={formData.question} name="question" onChange={changeFormData} onBlur={formatFormData} required/>
                    </label>
                    <label>
                        Correct Answer
                        <input type="text" name="correctAnswer" value={formData.correctAnswer} onChange={changeFormData} onBlur={formatFormData} required/>
                    </label>
                    <label>
                        Choice One
                        <input type="text" name="choiceOne" value={formData.choices.choiceOne} onChange={changeFormData} onBlur={formatFormData} required/>
                    </label>
                    <label>
                        Choice Two
                    ...
                    <label>
                        Choice Three
                        <input type="text" name="choiceThree" value={formData.choices.choiceThree} onChange={changeFormData} onBlur={formatFormData} required/>
                    </label>
                    <label>
                        Explantion
                        <textarea value={formData.explanation} name="explanation" onChange={changeFormData} onBlur={formatFormData} required/>
                    </label>
